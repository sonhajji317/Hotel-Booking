<div class="bg-amber-800 py-6 px-4 sm:px-6 lg:px-8 min-h-screen">
    <h2 class="text-center font-bold text-2xl text-amber-100 mb-6">Melawai Hotel Room Type</h2>

    <div class="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-3 gap-4 sm:gap-6">
        @foreach ($room_types as $room_type)
            <div class="p-2 sm:p-4">
                <a href="#" class="block rounded-lg bg-amber-100 shadow-md hover:shadow-xl transition p-4">
                    ...
                    <div class="mt-2 space-y-3">
                        ...
                        <!-- Deskripsi -->
                        <div>
                            <h5 class="text-green-700 text-sm font-bold text-center">Description</h5>
                        ...
                        <div class="mt-2 flex flex-wrap justify-between gap-4 text-xs">
                            ...
                            <div class="flex items-center gap-2 w-1/2 sm:w-auto">
                                ...
                                <div>
                                    ...
                                    <p class="font-bold text-gray-800">IDR
                                        {{ number_format($room_type->price, 0, ',', ',') }}/day</p>
                                </div>
                            </div>
